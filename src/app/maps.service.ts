...
export class MapsService {
    ...
    getmapsCoordinate(address: string){
        ...
        //let uri = 'https://maps.googleapis.com/maps/api/geocode/json?new_forward_geocoder=true&components=locality:paris&key=AIzaSyC5lQ_gp4v2XW3KTONULU5doLbU-C5g4hI';
    ...
    getmapsCoordinate_Autocomplete(address){
    ...
    async getmapsCoordinate2(address: string) {

        let uri = 'https://maps.googleapis.com/maps/api/geocode/json?address='+address+'&key=AIzaSyC5lQ_gp4v2XW3KTONULU5doLbU-C5g4hI';
        let response  = await this.http.get(uri).toPromise();
